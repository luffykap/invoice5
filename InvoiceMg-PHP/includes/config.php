...
define('COMPANY_ADDRESS_2','Basavanagudi');
define('COMPANY_ADDRESS_3','Bangalore');
define('COMPANY_COUNTY','India');
define('COMPANY_POSTCODE','560102');
...
// EMAIL DETAILS
define('EMAIL_FROM', 'rahul2000reddy@gmail.com'); // Email address invoice emails will be sent from
...
define('PAYMENT_DETAILS', 'Invoice Mg System.<br>Bank: SBI Basavangudi <br>Account Number: 12345678<br>IFSC: SBIN000345678'); // Payment information
